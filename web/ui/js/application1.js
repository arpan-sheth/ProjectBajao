...
function createResultDiv(i, doc){
	...
	var output='<li id="'+id+'" class="ui-state-default">'
...
function processJson(data) {
	...
	$.each(data.response.docs, function(i,doc){
		...
		//playing call
	$('li').click( function(first_event){
		alert("li clicked");
		alert($(first_event.target.id).html());
	
		$(".scroll-content").append('<div class="scroll-content-item ui-widget-header">'+$(first_event.target.id).html()+'</div>');
	}).unbind('click');
